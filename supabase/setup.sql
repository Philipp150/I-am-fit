...
values
('ex-neck-circles', null, 'Nacken langsam kreisen', 'Kleine Kreise, die den Nacken erinnern, dass er sich bewegen darf.', 'movement', array['cat-body', 'cat-neck', 'cat-mobility', 'cat-pause']::text[], array['comp-neck', 'comp-shoulders']::text[], '[{"pose":"stand","text":"Stell dich oder setz dich aufrecht hin. Schultern schwer, Kiefer locker.","durationSec":8},{"pose":"neckLeft","text":"Neige das linke Ohr zur Schulter. Nicht ziehen, nur nachgeben.","durationSec":8},{"pose":"neckRight","text":"Andere Seite. Kleiner als du denkst.","durationSec":8},{"pose":"neckLeft","text":"Jetzt ganz langsam kreisen: vor, zur Seite, hinten, zur anderen Seite.","durationSec":12},{"pose":"stand","text":"Komm zur Mitte zurück. Spüre, ob der Kopf leichter sitzt.","durationSec":8}]'::jsonb, 90, null, '{"kind":"daily","recommendedWeeks":null,"note":"Jeden Tag 1–2 Minuten, besonders nach Bildschirmarbeit. Das darf dauerhaft im Plan bleiben."}'::jsonb, '{"type":"catalog"}'::jsonb, true, '2026-01-01T09:00:00.000Z', '2026-01-01T09:00:00.000Z'),
('ex-shoulder-rolls', null, 'Schulterkreisen', 'Die Schultern nach hinten-unten schicken, statt sie am Ohr zu parken.', 'movement', array['cat-body', 'cat-shoulders', 'cat-posture', 'cat-pause']::text[], array['comp-shoulders', 'comp-neck']::text[], '[{"pose":"stand","text":"Arme hängen lassen. Spüre das Gewicht der Hände.","durationSec":8},{"pose":"shrug","text":"Schultern nach vorn und hoch, Richtung Ohren.","durationSec":8},{"pose":"chestOpen","text":"Weiter hinten, Schulterblätter zur Gesäßtasche.","durationSec":8},{"pose":"shouldersDown","text":"Unten ankommen lassen. Dann die Kreise langsam weiter.","durationSec":10},{"pose":"stand","text":"Prüfe: Sind die Schultern näher an den Hüften als am Kiefer?","durationSec":8}]'::jsonb, 80, null, '{"kind":"daily","recommendedWeeks":null,"note":"Unter der Woche mehrmals kurz, nicht einmal lang."}'::jsonb, '{"type":"catalog"}'::jsonb, true, '2026-01-01T09:00:00.000Z', '2026-01-01T09:00:00.000Z'),
...
('ex-478', null, '4-7-8 Atmung', 'Ein längeres Ausatmen, das das Nervensystem bremst.', 'breath', array['cat-body', 'cat-breath', 'cat-evening']::text[], array['comp-sleep', 'comp-stress']::text[], '[{"pose":"lie","text":"Liegen oder sitzen. Zungenspitze darf hinter den Schneidezähnen ruhen.","durationSec":8},{"pose":"breatheIn","text":"Einatmen, vier.","durationSec":4},{"pose":"breathe","text":"Halten, sieben.","durationSec":7},{"pose":"breatheOut","text":"Ausatmen, acht. Vier Runden reichen.","durationSec":8},{"pose":"lie","text":"Danach nichts weiter tun. Einfach liegen bleiben.","durationSec":8}]'::jsonb, 100, null, '{"kind":"daily","recommendedWeeks":null,"note":"Abends im Bett oder davor. Dauerhaft im Plan lassen."}'::jsonb, '{"type":"catalog"}'::jsonb, true, '2026-01-01T09:00:00.000Z', '2026-01-01T09:00:00.000Z'),
...
('ex-desk-break', null, 'Zwei-Minuten-Bildschirmpause', 'Nacken, Schultern, Atem – das, was du zwischen zwei Tasks vergisst.', 'movement', array['cat-daily', 'cat-pause', 'cat-neck', 'cat-shoulders']::text[], array['comp-neck', 'comp-shoulders', 'comp-focus']::text[], '[{"pose":"stand","text":"Steh auf. Ja, wirklich aufstehen.","durationSec":8},{"pose":"neckLeft","text":"Nacken zur einen Seite neigen.","durationSec":8},{"pose":"neckRight","text":"Zur anderen Seite.","durationSec":8},{"pose":"shrug","text":"Schultern einmal hoch.","durationSec":6},{"pose":"chestOpen","text":"Brust öffnen, Schultern hinten-unten.","durationSec":8},{"pose":"breatheIn","text":"Ein ruhiger Atemzug.","durationSec":4},{"pose":"breatheOut","text":"Und aus.","durationSec":4}]'::jsonb, 120, null, '{"kind":"weekdays","recommendedWeeks":null,"note":"An Arbeitstagen, idealerweise zweimal. Der Plan erinnert dich an eine Runde; die zweite ist Bonus."}'::jsonb, '{"type":"catalog"}'::jsonb, true, '2026-01-01T09:00:00.000Z', '2026-01-01T09:00:00.000Z'),
('ex-jaw-release', null, 'Kiefer locker lassen', 'Zunge, Zähne und Schläfen erinnern, dass sie nicht arbeiten müssen.', 'movement', array['cat-body', 'cat-neck', 'cat-pause', 'cat-daily']::text[], array['comp-neck', 'comp-stress']::text[], '[{"pose":"sit","text":"Lippen geschlossen, Zähne nicht. Zunge hinter den Schneidezähnen ablegen.","durationSec":8},{"pose":"jawSoft","text":"Kiefer ganz leicht nach links und rechts gleiten lassen. Kein Dehnen, nur Loslassen.","durationSec":16},{"pose":"shouldersDown","text":"Ein Atemzug in die Schläfen. Schultern dürfen mitfallen.","durationSec":8}]'::jsonb, 70, null, '{"kind":"weekdays","recommendedWeeks":null,"note":"An Arbeitstagen, sobald du merkst, dass die Zähne aufeinanderliegen."}'::jsonb, '{"type":"catalog"}'::jsonb, true, '2026-01-01T09:00:00.000Z', '2026-01-01T09:00:00.000Z'),
...
('ex-calf-stretch', null, 'Waden an der Wand', 'Eine Seite nach der anderen lang machen, ohne zu federn.', 'movement', array['cat-body', 'cat-knees', 'cat-mobility', 'cat-daily']::text[], array['comp-knees', 'comp-hips']::text[], '[{"pose":"stand","text":"Hände an die Wand, ein Fuß weit hinten, hintere Ferse bleibt am Boden.","durationSec":8},{"pose":"lunge","text":"Vorderes Knie beugen, hinteres Bein lang. Zwanzig Sekunden.","durationSec":16},{"pose":"stand","text":"Seite wechseln.","durationSec":8},{"pose":"lungeOther","text":"Andere Wade, gleiche Länge.","durationSec":16},{"pose":"shakeOut","text":"Ausschütteln. Waden dürfen warm sein, nicht brennen.","durationSec":8}]'::jsonb, 80, null, '{"kind":"days","daysOfWeek":[1,3,5],"timesPerWeek":3,"recommendedWeeks":4,"note":"Drei Mal pro Woche, besonders nach langem Stehen oder Gehen in starren Schuhen."}'::jsonb, '{"type":"catalog"}'::jsonb, true, '2026-01-01T09:00:00.000Z', '2026-01-01T09:00:00.000Z'),
...
('ex-walk-attention', null, 'Zwei Minuten gehen', 'Nur gehen und merken, dass die Füße den Boden treffen.', 'mind', array['cat-daily', 'cat-mindfulness', 'cat-pause']::text[], array['comp-focus', 'comp-stress']::text[], '[{"pose":"stand","text":"Aufstehen. Kein Ziel, nur ein paar Meter.","durationSec":8},{"pose":"walkLeft","text":"Langsam gehen. Ferse, Fußballen, Zehen – ein Fuß.","durationSec":8},{"pose":"walkRight","text":"Der andere Fuß. Gleich langsam.","durationSec":8},{"pose":"walkLeft","text":"Weiter: nur merken, dass die Füße den Boden treffen.","durationSec":10},{"pose":"stand","text":"Stehen bleiben. Einen Atemzug, dann zurück zu dem, was als Nächstes da ist.","durationSec":8}]'::jsonb, 120, null, '{"kind":"every_n_days","everyNDays":2,"recommendedWeeks":null,"note":"Alle zwei Tage, oder immer wenn der Kopf zu voll ist. Kein Trainingsspaziergang."}'::jsonb, '{"type":"catalog"}'::jsonb, true, '2026-01-01T09:00:00.000Z', '2026-01-01T09:00:00.000Z')
on conflict (id) do update set
