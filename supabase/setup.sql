...
values
('comp-neck', 'Nacken', 'Bewegung für Hals und Schultergürtel.', 'Kleine Bewegungen, oft, statt einmal hart zu dehnen.'),
('comp-shoulders', 'Schultern', 'Öffnen, absenken, Platz im Brustkorb.', 'Öffnen und absenken, nicht nur nach hinten ziehen.'),
('comp-back', 'Rücken', 'Länge und Wechsel aus Beugen und Strecken.', 'Sanft bleiben, nie in den Schmerz hinein.'),
('comp-hips', 'Hüfte', 'Becken und Hüftbeuger nach langem Sitzen.', 'Täglich kurz öffnen wirkt oft besser als selten lang.'),
('comp-knees', 'Knie', 'Kraft um das Gelenk, ruhige Beinachsen.', 'Kraft um das Gelenk, kein übertriebenes Dehnen.'),
('comp-stress', 'Ruhe', 'Atem und Anker, wenn der Tag zu laut ist.', 'Atem und Mantra zuerst, Bewegung nur so viel, wie der Tag noch trägt.'),
('comp-sleep', 'Schlaf', 'Runterkommen, bevor der Tag im Kopf weitergeht.', 'Atem und Mantra vor dem Liegen, kein Training spätabends.'),
('comp-focus', 'Fokus', 'Kurze Anker, die den Faden wiederfinden.', 'Kurze Anker, die du wirklich schaffst.'),
('comp-belly', 'Bauch', 'Mitte anschalten – Kraft, nicht Diagnose.', 'Kurze Reize, Atem behalten, Form vor Länge.'),
('comp-mobility', 'Beweglichkeit', 'Sanftes Öffnen und Fließen im Alltag.', 'Oft und klein schlägt selten und hart.'),
('comp-office', 'Büro', 'Zwischendurch am Schreibtisch: Nacken, Hände, Blick.', 'Aufstehen zählt. Zwei Minuten reichen.')
on conflict (id) do update set
  name = excluded.name,
...
('ex-plank', null, 'Stütze auf den Unterarmen', 'Mitte anschalten, ohne den Atem anzuhalten.', 'movement', array['cat-body', 'cat-strength', 'cat-posture']::text[], array['comp-back', 'comp-belly']::text[], '[{"pose":"plank","text":"Unterarme parallel, Becken weder durchhängen noch spitz nach oben. Schau auf den Boden.","durationSec":20},{"pose":"child","text":"Knie ab, kurz in die Kindeshaltung und nachspüren.","durationSec":8}]'::jsonb, 40, null, '{"kind":"days","daysOfWeek":[2,4,6],"timesPerWeek":3,"recommendedWeeks":8,"note":"Drei Mal pro Woche, 20–40 Sekunden. Länger nur, wenn die Form bleibt."}'::jsonb, '{"type":"catalog"}'::jsonb, true, '2026-01-01T09:00:00.000Z', '2026-01-01T09:00:00.000Z'),
('ex-belly-wake', null, 'Mitte wecken', 'Bauch und Becken kurz anschalten – Kraft für die Mitte, kein Diagnose-Programm.', 'movement', array['cat-body', 'cat-strength']::text[], array['comp-belly']::text[], '[{"pose":"stand","text":"Aufrecht stehen, Knie weich. Atem in den Bauch, nicht pressen.","durationSec":8},{"pose":"pelvicTuck","text":"Becken leicht kippen, Unterbauch anschalten.","durationSec":12},{"pose":"plank","text":"Kurze Stütze: Unterarme oder Knie. Mitte trägt, Atem bleibt.","durationSec":16},{"pose":"child","text":"Knie ab, kurz nachspüren.","durationSec":12},{"pose":"stand","text":"Wieder aufstehen. Die Mitte darf wach bleiben.","durationSec":8}]'::jsonb, 60, null, '{"kind":"daily","recommendedWeeks":null,"note":"Eine Minute, wenn du die Mitte spüren willst. Form vor Länge."}'::jsonb, '{"type":"catalog"}'::jsonb, true, '2026-01-01T09:00:00.000Z', '2026-01-01T09:00:00.000Z'),
